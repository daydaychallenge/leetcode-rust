...
/// https://github.com/aylei/leetcode-rust/blob/master/src/solution/s0097_interleaving_string.rs
...
impl Solution {
    ...
    fn dfs(s1: &Vec<char>, s2: &Vec<char>, s3: &Vec<char>,
        i: usize, j: usize, k: usize, invalid: &mut Vec<Vec<bool>>) -> bool {
        if invalid[i][j] {
            return false;
        }
